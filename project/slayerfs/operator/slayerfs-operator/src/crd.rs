...
#[kube(
    ...
    plural = "slayerfsclusters",
    namespaced,
    status = "SlayerFSClusterStatus",
    shortname = "sfs"
)]
pub struct SlayerFSClusterSpec {
    #[serde(default)]
    pub redis: RedisSpec,
    #[serde(default)]
...
#[kube(
    ...
    version = "v1alpha1",
    kind = "SlayerFSMount",
    plural = "slayerfsmounts",
    namespaced,
    status = "SlayerFSMountStatus",
    shortname = "sfsm"
)]
#[serde(rename_all = "camelCase")]
pub struct SlayerFSMountSpec {
    #[serde(rename = "clusterRef")]
    pub cluster_ref: SlayerFSClusterRef,
    #[serde(default)]
    pub workload_kind: MountWorkloadKind,
    #[serde(default = "default_slayerfs_image")]
    pub image: String,
...
#[serde(rename_all = "camelCase")]
pub struct SlayerFSClusterStatus {
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub struct SlayerFSMountStatus {
    pub observed_generation: Option<i64>,
    pub phase: String,
    pub message: String,
...
fn default_mount_point() -> String {
    "/mnt/slayerfs".to_string()
}

fn default_slayerfs_image() -> String {
    "slayerfs:local".to_string()
}
...
fn default_config_path() -> String {
    "/run/slayerfs/config.yaml".to_string()
}

fn default_state_path() -> String {
    "/var/lib/slayerfs".to_string()
}

fn default_log_level() -> String {
    "slayerfs=info".to_string()
}
