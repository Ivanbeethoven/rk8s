# SlayerFS Stats — Real-time Performance Monitor

## Overview

`slayerfs-stats` is a terminal-based real-time performance monitoring tool for SlayerFS,
...
slayerfs_fuse_lookup_lat_us_total 2000000
...
```
...
# Binary at target/debug/slayerfs-stats (or target/release/ with --release)
```
...
- No additional dependencies in the main slayerfs crate; CLI tool uses `crossterm` for colors
