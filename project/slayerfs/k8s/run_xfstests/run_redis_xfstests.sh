...
选项:
  ...
  --namespace <ns>           命名空间，默认: slayerfs-xfstests
  ...
  --rust-log <value>         设置 RUST_LOG，默认: slayerfs=info
...
K8S_NAMESPACE="slayerfs-xfstests"
XFSTESTS_IMAGE=""
...
SLAYERFS_FUSE_OP_LOG_VALUE="0"
RUST_LOG_VALUE="slayerfs=info"
KEEP=false
...
replacements = {
    ...
    "__SLAYERFS_FUSE_OP_LOG__": os.environ["SLAYERFS_FUSE_OP_LOG_VALUE"],
...
main() {
    ...
    export XFSTESTS_CHECK_ARGS_VALUE SLAYERFS_FUSE_OP_LOG_VALUE RUST_LOG_VALUE
